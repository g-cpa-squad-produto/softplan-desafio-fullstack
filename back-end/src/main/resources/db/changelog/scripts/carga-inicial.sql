...
insert into softplan.tb_usuario(us_id, us_email, us_nome, us_senha, us_situacao, pp_id) values (nextval('softplan.seq_usuario'), 'triador@teste.com', 'Triador', '$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.', 'ATIVO', (select pp_id from softplan.tb_papel where pp_descricao = 'Usuário-Triador'));
insert into softplan.tb_usuario(us_id, us_email, us_nome, us_senha, us_situacao, pp_id) values (nextval('softplan.seq_usuario'), 'finalizador@teste.com', 'Finalizador', '$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.', 'ATIVO', (select pp_id from softplan.tb_papel where pp_descricao = 'Usuário-Finalizador'));
