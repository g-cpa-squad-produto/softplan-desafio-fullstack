...
INSERT INTO PUBLIC.USUARIOS (id, nome, email, senha, perfil) VALUES (NEXTVAL('public.seq_usuarios'), 'Usuário administrador', 'admin@dominio.com', 'B03FA9D785A4AEB962F3F143C9F6E1C51D004C42B8DE0952D75FBB742C361FBB', 'A');
INSERT INTO PUBLIC.USUARIOS (id, nome, email, senha, perfil) VALUES (NEXTVAL('public.seq_usuarios'), 'Usuário triador', 'triador@dominio.com', 'B03FA9D785A4AEB962F3F143C9F6E1C51D004C42B8DE0952D75FBB742C361FBB', 'T');
INSERT INTO PUBLIC.USUARIOS (id, nome, email, senha, perfil) VALUES (NEXTVAL('public.seq_usuarios'), 'Usuário finalizador', 'finalizador@dominio.com', 'B03FA9D785A4AEB962F3F143C9F6E1C51D004C42B8DE0952D75FBB742C361FBB', 'F');
