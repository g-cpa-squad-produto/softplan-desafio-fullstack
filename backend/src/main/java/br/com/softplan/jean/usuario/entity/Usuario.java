...
public class Usuario implements Serializable {
	...
	public Usuario(@NotBlank @Size(min = 2, max = 100) String nome, @NotBlank @Size(min = 5, max = 20) String login,
			@NotBlank @Size(min = 5, max = 12) String senha, @NotNull TipoUsuario tipoUsuario) {
		super();
		this.nome = nome;
		this.login = login;
		this.senha = senha;
