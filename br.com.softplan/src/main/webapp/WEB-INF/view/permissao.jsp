                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">
                                        <form name="frmPermissoes" id="frmPermissoes" method="post" action="home" accept-charset="ISO-8859-1">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        ...
                                                        <th>Visualizar</th>
                                                        <th colspan="2">
                                                        	<button name="add-perm" id="manager-perm" type="button" class="btn btn-primary pull-center">Adicionar</button>
<!--                                                         	onclick="managerPerm('');" -->
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <c:forEach var="perm" items="${permissoes}">
                                                        <tr>
                                                            <td>${perm.id}</td>
                                                            <td>${perm.nome}</td>
                                                            <td>${perm.incluirString}</td>
                                                            <td>${perm.alterarString}</td>
                                                            <td>${perm.excluirString}</td>
                                                            <td>${perm.visualizarString}</td>
                                                            <td>
                                                                 <a href="#" id="manager-perm" title="Alterar">
<%--                                                                  onclick="managerPerm('${perm.id}');" --%>
                                                                     <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i>
                                                                 </a>
                                                               &nbsp;&nbsp;
                                                              	 <a href="#" id="excluir-perm" title="Excluir">
<%--                                                               	 onclick="excluirPerm('${perm.id}');" --%>
                                            ...
                                            <input name="idPermissao" id="idPermissao" type="hidden" value="">
        ...
        <script>
            ...
            function managerPerm(idUsuario) {
                $('input#acao').val('8');
                $('input#idPermissao').val(idPermissao);
