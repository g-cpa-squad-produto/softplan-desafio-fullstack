                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">
                                        <form name="frmProcessos" id="frmProcessos" method="post" action="home" accept-charset="ISO-8859-1">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Nome</th>
                                                        <th colspan="2">
                                                        	<button name="add-processo" id="manager-processo" type="button" 
                                                                    class="btn btn-primary pull-center">Adicionar</button>
<!--                                                                     onclick="managerProcesso('');" -->
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <c:forEach var="processo" items="${processos}">
                                                        <tr>
                                                            ...
                                                            <td>${processo.nome}</td>
                                                            <td>
                                                                 <a href="#" id="manager-processo" title="Alterar" >
<%--                                                                  onclick="managerProcesso('${processo.id}');" --%>
                                                                     <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i>
                                                                 </a>
                                                               &nbsp;&nbsp;
                                                              	 <a href="#" id="excluir-processo" title="Excluir" >
<%--                                                               	 onclick="excluirProcesso('${processo.id}');" --%>
                                            ...
                                            <input name="idProcesso" id="idProcesso" type="hidden" value="">
        ...
        <script>
            ...
            function managerProcesso(idProcesso) {
                $('input#acao').val('manager-processo');
                $('input#idProcesso').val(idProcesso);
                $('#frmProcessos').submit();
            } 

            function excluirProcesso(idProcesso) {
	             $('input#acao').val('excluir-processo');
	             $('input#idProcesso').val(idProcesso);
	             $('#frmProcessos').submit();
             }
        </script>
