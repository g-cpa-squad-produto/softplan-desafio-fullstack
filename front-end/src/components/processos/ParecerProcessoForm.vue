        ...
        <b-container fluid>
            ...
            <b-form @submit="onSubmit" @reset="onReset" >
                ...
                <b-form-group id="input-group-numero" label="Número:" label-for="input-numero">
                    <b-form-input id="input-numero" v-model="parecer.processo.numero" disabled placeholder="Número"></b-form-input>
                </b-form-group>

                <b-form-group id="input-group-descricao" label="Descrição:" label-for="input-descricao" >
                    <b-form-input id="input-descricao" v-model="parecer.processo.descricao" type="text" disabled placeholder="Descrição"></b-form-input>
                </b-form-group>

                <b-form-group id="input-group-parecer" label="Descrição:" label-for="input-parecer" >
                    <b-form-textarea id="input-parecer" v-model="parecer.parecer" required placeholder="Parecer"></b-form-textarea>
                </b-form-group>
